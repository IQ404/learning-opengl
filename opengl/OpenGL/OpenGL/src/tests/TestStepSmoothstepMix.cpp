#include "TestStepSmoothstepMix.h"
#include "DebugTools.h"
#include "imgui/imgui.h"

namespace Test
{
	TestStepSmoothstepMix::TestStepSmoothstepMix(const std::string& test_name)
        ...
        TestBase(test_name)
	{
        ...
        {
            //  position:            uv:
                -200.0f,-230.0f,    0.0f,0.0f,    // vertex 1
                 200.0f,-230.0f,    1.0f,0.0f,    // vertex 2
                 200.0f, 230.0f,    1.0f,1.0f,    // vertex 3
                -200.0f, 230.0f,    0.0f,1.0f     // vertex 4
        };
        ...
        m_shader = std::make_unique<Shader>("res/shaders/StepSmoothstepMix.shader");
	...
	TestStepSmoothstepMix::~TestStepSmoothstepMix()
	{
	...
	void TestStepSmoothstepMix::OnUpdate(float dt)
	{

	}

	void TestStepSmoothstepMix::OnRender()
	{
        m_renderer.Draw(*m_vao, *m_index_buffer, *m_shader);
	}

	void TestStepSmoothstepMix::OnImGuiRender()
	{
