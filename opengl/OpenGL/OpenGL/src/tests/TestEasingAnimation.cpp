...
namespace Test
{
    TestEasingAnimation::TestEasingAnimation(const std::string& test_name)
        ...
        TestBase(test_name)
	{
        ...
        m_model_shader = std::make_unique<Shader>("res/shaders/EasingAnimation.shader");
	...
	TestEasingAnimation::~TestEasingAnimation()
	{
	...
	void TestEasingAnimation::OnUpdate(float dt)
	{
        m_model_shader->Bind();
	...
	void TestEasingAnimation::OnRender()
	{
        SkyboxPass();
        ModelPass();
	}

	void TestEasingAnimation::OnImGuiRender()
	{
    ...
    void TestEasingAnimation::SkyboxPass()
    {
    ...
    void TestEasingAnimation::ModelPass()
    {
        m_view_matrix = 
            glm::rotate(glm::mat4{ 1.0f }, -glm::radians(m_camera_vertical_rotation), glm::vec3(1, 0, 0)) *
            glm::rotate(glm::mat4{ 1.0f }, glm::radians(m_camera_horizontal_rotation), glm::vec3(0, 1, 0));
