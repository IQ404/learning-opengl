#ifndef TESTEASINGANIMATION_H
#define TESTEASINGANIMATION_H
...
namespace Test
{
	class TestEasingAnimation : public TestBase
	{
		Renderer m_renderer;
	...
	public:
		TestEasingAnimation(const std::string& test_name);
		~TestEasingAnimation() override;
